...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [self.closeButton setTitle:@"Save" forState:UIControlStateNormal];
        [self.closeButton addTarget:self action:@selector(saveImage) forControlEvents:UIControlEventTouchUpInside];
...
- (void)viewDidLoad
{
    ...
    frame.origin = CGPointMake(10, CGRectGetHeight(self.view.frame) - 44 -20);
